...
AddEventHandler('humanelabsheist:client:policeAlert', function(targetCoords)
    ...
    local alpha = 250 -- sta/sz/ek#/96/09
...
function TakeAnimation()
    ...
    loadAnimDict(animDict) -- sta/sz/ek#/96/09
...
function Outro()
    ...
    loadAnimDict('mini@biotech@blowtorch_str') -- sta/sz/ek#/96/09
...
AddEventHandler('humanelabsheist:client:wearWetsuit', function()
    ...
    if diving then
        ...
        loadModel(tankModel) -- sta/sz/ek#/96/09
